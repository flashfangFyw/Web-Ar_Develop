...
//								"property '{1}'", inst_type, property));
                                               ...
                                               JsonReader reader)
        {
           ...
           // TestJson.addLog("ffffffffffff:" + reader.Value);
            if (reader.Token == JsonToken.Int) {
                instance.SetInt ((int) reader.Value);
               // TestJson.addLog("ooooooo:" + reader.Value);
                return instance;
            }
            //TestJson.addLog("ggggggggggg:" + reader.Value);
            if (reader.Token == JsonToken.Long) {
                instance.SetLong ((long) reader.Value);
                return instance;
            }
            //TestJson.addLog("hhhhhhhhhh:" + reader.Value);
            if (reader.Token == JsonToken.Boolean) {
                instance.SetBoolean ((bool) reader.Value);
                return instance;
            }
           // TestJson.addLog("iiiiiiiiii:" + reader.Value);
            ...
            //TestJson.addLog("jjjjjjjjjjjj:" + reader.Value);
            return instance;
        }
        ...
        {
            //TestJson.addLog("2222222222222");
            JsonReader reader = new JsonReader (json);
            //TestJson.addLog("333333333333");
            return ReadValue (factory, reader);
        }
