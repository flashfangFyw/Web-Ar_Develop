...
namespace ffDevelopmentSpace
{
    public class Util
    {
        ...
        //     GameObject prefab = SingletonMB<ResourceManagerController>.GetInstance().LoadAsset(assetName, assetName);
        //     if (prefab == null)
        //     {
        ...
        //     GameObject prefab = SingletonMB<ResourceManagerController>.GetInstance().LoadAsset(pkgName, assetName);
        //     if (prefab == null)
        //     {
        ...
        //{
        //    if (pkgName == "" || assetName == "") return null;
        //    Sprite prefab = SingletonMB<ResourceManagerController>.GetInstance().LoadSprite(pkgName, assetName);
        //    if (prefab == null)
        //    {
